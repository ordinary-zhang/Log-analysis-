                  ...
                  if(line.contains("INFO")==true || line.contains("WARN")==true || line.contains("ERROR")==true || line.contains("DEBUG")==true || line.contains("FATAL")){
                	  ...
                	  if(tmpevent.length()>0){
                		  ...
                		  if(tmpremainlines.length()>0){ 
							...
							{"time":"2017-02-28 17:14:03,490","logtype":"DEBUG","loginfo":"org.apache.hadoop.hdfs.server.datanode.DataNode:Receiving one packet for block BP-116669189-192.168.1.110-1448769719691:blk_796610962946870242_1563368: PacketHeader with packetLen=0 header data: offsetInBlock: 56
							seqno: 1
							...
							{"time":"2017-02-28 16:43:07,292","logtype":"INFO","loginfo":"org.apache.coyote.http11.Http11Protocol:Pausing ProtocolHandler ["http-bio-8080"]"}
                			   ...
                			   * c.
                			   *  {"time":"2017-04-12 16:16:02,481","logtype":"INFO","loginfo":"org.apache.hadoop.hdfs.server.datanode.DataNode:SHUTDOWN_MSG: 
							   *  /************************************************************
